...
export function RecentRfps({ rfps }: { rfps: Rfp[] }) {
  return (
    <Card className="overflow-hidden p-0">
      <div className="border-b border-border px-6 py-4">
        <h2 className="font-sans text-lg font-semibold text-ink">Recent RFPs</h2>
      </div>
        ...
        {rfps.map((rfp) => (
          <li key={rfp.id}>
            <Link
              ...
              className="flex flex-col gap-2 px-6 py-4 transition-colors duration-hover ease-out hover:bg-surface sm:flex-row sm:items-center sm:justify-between"
            >
